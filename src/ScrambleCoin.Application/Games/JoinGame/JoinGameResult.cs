...
/// </summary>
/// <param name="PlayerId">
/// The player-slot identifier the bot must use for all later game actions
/// (PlacePiece, MovePiece, etc.).
/// </param>
/// <param name="Token">The bearer token the bot must supply on every later request.</param>
