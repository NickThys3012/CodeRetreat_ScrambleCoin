...
public interface ICoinSpawnService
{
    ...
    /// </summary>
    public Task ExecuteAsync(Guid gameId, CancellationToken cancellationToken = default);

    /// <summary>
    /// Spawns coins on an already-loaded <paramref name="game"/>, advances phase, and saves.
    /// </summary>
    public Task ExecuteForGameAsync(Game game, CancellationToken cancellationToken = default);
}
